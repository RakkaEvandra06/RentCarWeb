...
<html lang="en">
  ...
  <body>
    ...
    <div class="mx-auto w-full max-w-[550px] bg-gray">
        <form action="#"
            ...
            <div class="mb-2 block text-sm font-medium text-gray-900 dark:text-white">
                <label for="name" class="mb-3 block text-base font-medium text-[#e0e0e0]">
                    Full Name
                </label>
            ...
            <div class="mb-2 block text-sm font-medium text-gray-900 dark:text-white">
                <label for="phone" class="mb-3 block text-base font-medium text-[#e0e0e0]">
                    Phone Number
                </label>
            ...
            <div class="-mx-3 flex flex-wrap">
                <div class="w-full px-3 sm:w-1/2">
                    <div class="mb-2 block text-sm font-medium text-gray-900 dark:text-white">
                        <label for="date" class="mb-3 block text-base font-medium text-[#e0e0e0]">
                            Date
                        </label>
                ...
                <div class="w-full px-3 sm:w-1/2">
                    <div class="mb-2 block text-sm font-medium text-gray-900 dark:text-white">
                        <label for="time" class="mb-3 block text-base font-medium text-[#e0e0e0]">
                            Time
                        </label>
            ...
            <div class="mb-5 pt-3">
                <label class="mb-5 block text-base font-semibold text-[#e0e0e0] sm:text-xl">
                    Address Details
                </label>
                <div class="-mx-3 flex flex-wrap">
                    <div class="w-full px-3 sm:w-1/2">
    ...
    <section class="bg-white py-8 antialiased dark:bg-gray-900 md:py-16">
      <div class="mx-auto max-w-screen-x px-4 2xl:px-0">
